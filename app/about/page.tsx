...
export const metadata: Metadata = {
  title: "About Us",
  description: "The story behind AquaRealm Fish, a home-based aquarium fish breeder in Kathmandu Valley."
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
      <h1 className="text-2xl sm:text-3xl font-medium text-plum mb-6">About AquaRealm Fish</h1>
      <div className="space-y-4 text-sm sm:text-base text-ink-muted leading-relaxed">
        <p>
          AquaRealm Fish started with a simple passion for aquarium fish and home breeding. What began as a
